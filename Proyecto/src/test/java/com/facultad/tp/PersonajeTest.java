...
public class PersonajeTest {
    ...
    public void testCreacionEstudiante() {
        Estudiante estudiante = new Estudiante("Ron", 45, 90);
    ...
    public void testCreacionProfesor() {
        Profesor profesor = new Profesor("Dumbledore", 95, 180);
    ...
    public void testCreacionSeguidor() {
        Seguidor seguidor = new Seguidor("Mortifago1", 60, 110);
    ...
    public void testCreacionComandante() {
        Comandante comandante = new Comandante("Voldemort", 90, 200);
    ...
    public void testMagoCalculaDanioReducido() {
        Mago mago = new Auror("Harry", 100, 150);
    ...
    public void testMortifagoCalculaDanioAumentado() {
        Mortifago mortifago = new Comandante("Voldemort", 100, 200);
    ...
    public void testPolimorfismoDanio() {
        Personaje mago = new Auror("Harry", 50, 150);
        Personaje mortifago = new Seguidor("Mortifago", 50, 150);
